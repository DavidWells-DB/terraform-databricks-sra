...
variable "executor_user_email" {
  description = "Optional: executor user email to grant catalog admin"
  type        = string
  default     = ""
}

variable "admin_sp_client_id" {
  description = "Optional: service principal client ID to grant catalog admin"
  type        = string
  default     = null
}

variable "terraform_sp_client_id" {
  description = "Optional: executor service principal client ID to grant catalog admin"
  type        = string
  default     = null
}
